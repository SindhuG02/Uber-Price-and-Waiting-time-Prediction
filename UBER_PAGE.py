...
def app():
    ...
    if Submitted:
        ...
        predicted_UberGo=predictData.get_prediction('Page1_model','Uber Go',start_time,From,To)
        ...
        with col2:
            ...
            st.subheader(f"Price ₹{predicted_UberGo[0]}")
            
        predicted_GoSedan=predictData.get_prediction('Page1_model','Go Sedan',start_time,From,To)
        ...
        with col2:
            ...
            st.subheader(f"Price ₹{predicted_GoSedan[0]}")
        ...
        predicted_UberGo2=predictData.get_prediction('Page1_model','Uber Go',start_time1,From,To)
        predicted_UberGo3=predictData.get_prediction('Page1_model','Uber Go',start_time2,From,To)
        predicted_GoSedan2=predictData.get_prediction('Page1_model','Go Sedan',start_time1,From,To)
        predicted_GoSedan3=predictData.get_prediction('Page1_model','Go Sedan',start_time2,From,To)
        
        actualUberGo_value=predicted_UberGo[0].replace(",","")
        PredictedUberGo_value1=predicted_UberGo2[0].replace(",","")
        PredictedUberGo_value2=predicted_UberGo3[0].replace(",","")

        differenceUberGo=(float(actualUberGo_value)-float(actualUberGo_value))
        differenceUberGo1=(float(PredictedUberGo_value1)-float(actualUberGo_value))
        ...
        differenceUberGo2=(float(PredictedUberGo_value2)-float(actualUberGo_value))
        ...
        actualGoSedan_value=predicted_GoSedan[0].replace(",","")
        PredictedGoSedan_value1=predicted_GoSedan2[0].replace(",","")
        PredictedGoSedan_value2=predicted_GoSedan3[0].replace(",","")

        differenceGoSedan=(float(actualGoSedan_value)-float(actualGoSedan_value))
        differenceGoSedan1=(float(PredictedGoSedan_value1)-float(actualGoSedan_value))
        if differenceGoSedan1==0:
            ...
            GoSedansign1='↓'
        differenceGoSedan2=(float(PredictedGoSedan_value2)-float(actualGoSedan_value))
        ...
        df=pd.DataFrame(details,columns=["Time","Car_Type","Price","Price_Difference_of","Increased/Decreased"])  
        st.dataframe(df)